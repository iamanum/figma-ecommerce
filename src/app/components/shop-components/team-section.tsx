    ...
    <section className="py-16 bg-white">
        ...
        {teamMembers.map((member, index) => (
          <div key={index} className="text-center">
            ...
            <Image
              ...
              width={316}
              height={231}
              className="mx-auto transition-transform duration-300 hover:scale-105 hover:shadow-lg rounded-md"
            />
            ...
            <div className="flex justify-center mt-3 space-x-4">
              ...
              <Link
                ...
                className="text-[#23A6F0] hover:text-blue-600 transition-colors duration-300"
              >
                <FaFacebookF size={25} />
              </Link>
              <Link
                href={member.social.instagram}
                className="text-[#23A6F0] hover:text-pink-500 transition-colors duration-300"
              >
                <FaInstagram size={25} />
              </Link>
              <Link
                href={member.social.twitter}
                className="text-[#23A6F0] hover:text-blue-400 transition-colors duration-300"
              >
                <FaTwitter size={25} />
              </Link>
            </div>
      ...
      <div className="py-16 bg-[#FFFFFF] text-center mt-20">
        ...
        <div className="flex justify-center mt-10">
          <Link
            href="#"
            className="text-[#55ACEE] mx-2 hover:text-blue-400 transition-colors duration-300"
          >
            <FaTwitter size={30} />
          </Link>
          <Link
            href="#"
            className="text-[#395185] mx-2 hover:text-blue-600 transition-colors duration-300"
          >
            <FaFacebookF size={30} />
          </Link>
          <Link
            href="#"
            className="text-[#000000] mx-2 hover:text-gray-600 transition-colors duration-300"
          >
            <FaInstagram size={30} />
          </Link>
          <Link
            href="#"
            className="text-[#0A66C2] mx-2 hover:text-blue-800 transition-colors duration-300"
          >
