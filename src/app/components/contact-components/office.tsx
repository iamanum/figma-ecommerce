    ...
    <div className="flex flex-col items-center justify-center text-center py-10 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          <div
            key={index}
            className={`relative overflow-hidden rounded-lg shadow-md p-6 max-w-sm text-center transition-transform transform hover:scale-105 ${
              index === 1
          ...
          >
            {/* Icon */}
            <div className="flex justify-center items-center mb-4 transform transition-transform duration-300 hover:rotate-12">
              {card.icon}
            </div>
            ...
            <button
              className={`${
                index === 1
                  ...
                  : "bg-transparent border border-[#23A6F0] text-[#23A6F0] hover:bg-[#23A6F0] hover:text-white"
              } font-bold py-4 px-6 rounded-full transition duration-300 transform hover:scale-110`}
            >
              {card.button}
            </button>
          </div>
      ...
      <div className="mt-16 py-10 text-center">
        ...
        <div className="flex justify-center items-center">
          <FiArrowDown className="text-[#23A6F0] text-[48px] transform rotate-0 hover:rotate-45 transition duration-300" />
        </div>
        ...
        {/* Button */}
        <button className="bg-[#23A6F0] text-[#FFFFFF] px-8 py-4 rounded-md m-4 hover:bg-blue-500 transform hover:scale-105 transition duration-300">
          Try it free now
        </button>
      </div>
    </div>
