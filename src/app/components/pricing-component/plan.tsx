  ...
  return (
    <div className="bg-[#FAFAFA] py-12">
      ...
      <div className="flex items-center justify-center mt-10 gap-4">
        ...
        <div
          className={`w-14 h-7 flex items-center rounded-full p-1 cursor-pointer border border-[#23A6F0] transition-all duration-300`}
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
        {/* Free Plan */}
        <div className="border-2 border-[#23A6F0] rounded-lg p-6 bg-transparent shadow-md h-[664px] flex flex-col justify-between transition-transform transform hover:scale-105 hover:shadow-lg">
          <div>
          ...
          <button className="bg-[#252B42] text-[#FFFFFF] font-bold text-[14px] px-8 py-4 flex justify-center items-center rounded-md mx-auto hover:bg-gray-800 transform hover:scale-105 transition-transform duration-300">
            Try for free
          </button>
        </div>

        {/* Standard Plan */}
        <div className="border-2 border-[#23A6F0] rounded-lg p-6 bg-[#252B42] shadow-md h-[700px] flex flex-col justify-between transition-transform transform hover:scale-105 hover:shadow-lg">
          <div>
          ...
          <button className="bg-[#23A6F0] text-[#FFFFFF] font-bold text-[14px] px-8 py-4 flex justify-center items-center rounded-md mx-auto hover:bg-blue-500 transform hover:scale-105 transition-transform duration-300">
            Try for Standard
          </button>
        </div>
