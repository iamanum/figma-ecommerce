...
import { FaFacebookF, FaTwitter, FaYoutube } from "react-icons/fa"; // Icons for social media
...
<Link
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="flex items-center justify-center w-5 h-5 rounded-full bg-white text-[#3b5998] hover:opacity-80 transition-opacity"
>
  <FaFacebookF size={15} />
</Link>
